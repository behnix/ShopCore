...
namespace App.Migrations
{
    ...
    [Migration("20190220131029_AddProductsRelatedTables")]
    partial class AddProductsRelatedTables
    {
            ...
            modelBuilder.Entity("App.Domain.Entities.Product.Product", b =>
                {
                    ...
                    b.Property<long>("PriceCoworkerPromotion");
                    ...
                    b.Property<long>("TempPrice");

                    b.Property<long>("TempPriceCoworker");
            ...
            modelBuilder.Entity("App.Domain.Entities.Product.Image", b =>
                {
                    b.HasOne("App.Domain.Entities.Product.Product")
                        .WithOne("Image")
                        .HasForeignKey("App.Domain.Entities.Product.Image", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
